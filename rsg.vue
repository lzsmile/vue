<template>
    <div class="content">
        <p class="fhbtn"><a class="jtou" href="javascript:window.history.go(-1);"></a></p>
        <h1></h1>
        <div class="login-box">
            <p class="lsolid"></p>
            <div class="login">
                <router-link to="/login" @click.native="hidefootba">登录</router-link>
                <span></span>
                <router-link to="/rsg" @click.native="hidefootba">注册</router-link>
            </div>
            <p class="rsolid"></p>
        </div>
        <ul>
...
<style scoped>
    ...
    .content .fhbtn .jtou{ position: absolute;width:0.5rem;height:0.5rem; background:url(../assets/img/history1.png) no-repeat 0 0; background-size:100%; left:0.5rem}
    .content h1{width:2.18rem;height:1.35rem; background:url(../assets/img/say.png) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:5rem;}
